    ...
    <>
      ...
      <main className="pt-32 pb-28 px-6 min-h-screen bg-cream">
        <div className="max-w-2xl mx-auto">
          ...
          {/* Location note */}
          <div className="mb-12 border-l-2 border-ember pl-5">
            <p className="font-body text-sm text-dark/50 leading-relaxed">
              Base package covers locations within 50 miles of Lusby, MD.
              Shoots beyond 50 miles are available at an additional travel fee.
            </p>
          </div>
